<x-admin-app-layout :title="'Service All'">
        ...
        <script>
            $(document).ready(function() {
                $('.status-toggle').change(function() {
                    ...
                    $.ajax({
                        url: '/admin/service/status/' + bannerId,
                        method: 'PUT',
                        data: {
                            _token: '{{ csrf_token() }}',
                            status: newStatus
                        ...
                        success: function(response) {
                            if (newStatus === 'active') {
                                toastr.success('Service has been activated successfully.');
                            } else {
                                toastr.error('Service has been deactivated successfully.');
                            }
                        },
                        error: function(xhr) {
