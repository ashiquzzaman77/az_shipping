<x-admin-app-layout :title="'Legal Create'">
    ...
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.legal.store') }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="course-banner-container">
                                ...
                                <div id="image-preview" style="display:none; margin-top: 10px; position: relative;">
                                    ...
                                    <button type="button" id="remove-image"
                                        style="position: absolute; top: 10px; right: 347px; background: rgba(12, 12, 12, 0.925); color: white; border: none; width:35px;height:35px; border-radius: 50%; padding: 1px; cursor: pointer; font-size: 22px;">
                                        ×
                                    </button>
                                </div>
                            </div>
