<x-admin-app-layout :title="'Choose All'">
    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('admin.choose.create') }}" class="btn btn-light-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                {{-- @if (Auth::guard('admin')->user()->can('edit.banner')) --}}
                                    <a href="{{ route('admin.choose.edit', $item->id) }}" class="text-primary">
                                        <i class="fa-solid fa-pencil text-primary"></i>
                                    </a>
                                {{-- @endif

                                @if (Auth::guard('admin')->user()->can('delete.choose')) --}}
                                    <a href="{{ route('admin.choose.destroy', $item->id) }}" class="delete">
        ...
        <script>
            $(document).ready(function() {
                $('.status-toggle').change(function() {
                    ...
                    $.ajax({
                        url: '/admin/choose/status/' + bannerId,
                        method: 'PUT',
                        data: {
                            _token: '{{ csrf_token() }}',
                            status: newStatus
                        ...
                        success: function(response) {
                            if (newStatus === 'active') {
                                toastr.success('Choose has been activated successfully.');
                            } else {
                                toastr.error('Choose has been deactivated successfully.');
                            }
                        },
                        error: function(xhr) {
