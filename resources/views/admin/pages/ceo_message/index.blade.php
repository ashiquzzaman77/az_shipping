<x-admin-app-layout :title="'Ceo Message'">
    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('admin.ceo_message.create') }}" class="btn btn-light-primary">
                    ...
                    @foreach ($items as $key => $item)
                        <tr>
                            ...
                            <td class="">
                                ...
                                <img class=""
                                    src="{{ !empty($item->ceo_image) ? url('storage/' . $item->ceo_image) : 'https://ui-avatars.com/api/?name=' . urlencode('CEO') }}"
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.ceo_message.edit', $item->id) }}" class="text-primary">
                ...
                $('.status-toggle').change(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (newStatus === 'active') {
                                toastr.success('Message has been activated successfully.');
                            } else {
                                toastr.error('Message has been deactivated successfully.');
                            }
                        },
                        error: function(xhr) {
