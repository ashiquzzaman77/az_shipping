<x-admin-app-layout :title="'Ceo Message Create'">
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.ceo_message.store') }}"
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="ceo_short_msg" class="form-control" cols="3" rows="3">{{ old('ceo_short_msg') }}</textarea>
                                @error('ceo_short_msg')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="message" class="form-control editor">{{ old('message') }}</textarea>
                                @error('message')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
