<x-admin-app-layout :title="'Terms and Policy Create'">
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.policy.store') }}"
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="expiration_date" class="form-control form-control-sm"
                                    value="{{ old('expiration_date', now()->format('Y-m-d')) }}"
                                    min="{{ now()->format('Y-m-d') }}">
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="version" placeholder="Enter Version"
                                    class="form-control form-control-sm" value="{{ old('version') }}">
                                @error('version')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
