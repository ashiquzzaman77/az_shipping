<x-admin-app-layout :title="'Principle Create'">
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.principle.store') }}"
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="short_descp" class="form-control" id="" cols="4" rows="4">{{ old('short_descp') }}</textarea>
                                @error('short_descp')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
