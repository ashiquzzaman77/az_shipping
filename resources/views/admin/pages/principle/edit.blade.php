<x-admin-app-layout :title="'Principle Edit'">
    <div class="card card-flash">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.principle.index') }}" class="btn btn-light-primary rounded-2">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.principle.update', $principle->id) }}"
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <select name="status" data-placeholder="Select Row One.."
                                    ...
                                    <option value="active" {{ $principle->status === 'active' ? 'selected' : '' }}>Active
                                    </option>
                                    <option value="inactive" {{ $principle->status === 'inactive' ? 'selected' : '' }}>
                                        Inactive</option>
                                </select>
                                @error('status')
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="principle Name"
                                    class="form-control form-control-sm" value="{{ old('name', $principle->name) }}">
                                @error('name')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="short_descp" class="form-control" id="" cols="4" rows="4">{!! $principle->short_descp !!}</textarea>
                                @error('short_descp')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control editor" id="" cols="4" rows="4">{!! $principle->description !!}</textarea>
                                @error('description')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-4 mb-3">
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <img class=""
                                            src="{{ !empty($principle->thumbnail_image) ? url('storage/' . $principle->thumbnail_image) : 'https://ui-avatars.com/api/?name=' . urlencode('SS') }}"
                        ...
                        <div class="col-8 mb-3">
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <img class=""
                                            src="{{ !empty($principle->banner_top_image) ? url('storage/' . $principle->banner_top_image) : 'https://ui-avatars.com/api/?name=' . urlencode('SS') }}"
                        ...
                        <div class="col-6 mb-3">
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <img class=""
                                            src="{{ !empty($principle->banner_center_image) ? url('storage/' . $principle->banner_center_image) : 'https://ui-avatars.com/api/?name=' . urlencode('SS') }}"
                                            height="60" width="100" alt="">
                                    </div>
                                </div>
