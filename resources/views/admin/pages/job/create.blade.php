<x-admin-app-layout :title="'Job Create'">
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="experienced" placeholder="Eg: 12+years"
                                    class="form-control form-control-sm" value="{{ old('experienced') }}">
                                @error('experienced')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="salary" placeholder="Eg: $1200-$1500"
                                    class="form-control form-control-sm" value="{{ old('salary') }}">
                                @error('salary')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="long_descp" class="form-control editor" cols="30" rows="10">{{ old('long_descp') }}</textarea>
                                @error('long_descp')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
