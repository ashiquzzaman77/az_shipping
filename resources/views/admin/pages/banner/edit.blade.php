<x-admin-app-layout :title="'Banner Edit'">
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.banner.update', $banner->id) }}"
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" data-placeholder="Select Row One.."
                                    ...
                                    <option value="active"
                                        {{ old('status', $banner->status) == 'active' ? 'selected' : '' }}>Active
                                    </option>
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="badge" placeholder="Banner Badge"
                                    class="form-control form-control-sm" value="{{ old('badge', $banner->badge) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" placeholder="Banner Title"
                                    class="form-control form-control-sm" value="{{ old('title', $banner->title) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact" placeholder="Banner Contact Url"
                                    class="form-control form-control-sm" value="{{ old('contact', $banner->contact) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-4 mb-3">
                            <div class="">
                                ...
                                <img class="mt-3"
                                    src="{{ !empty($banner->image) ? url('storage/banner/' . $banner->image) : 'https://ui-avatars.com/api/?name=' . urlencode($banner->title) }}"
