<x-admin-app-layout :title="'Mision All'">
    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('admin.mision.create') }}" class="btn btn-light-primary">
        ...
        <script>
            $(document).ready(function() {
                $('.status-toggle').change(function() {
                    ...
                    $.ajax({
                        url: '/admin/mision/status/' + bannerId,
                        method: 'PUT',
                        data: {
                            _token: '{{ csrf_token() }}',
                            status: newStatus
                        ...
                        success: function(response) {
                            if (newStatus === 'active') {
                                toastr.success('Mission has been activated successfully.');
                            } else {
                                toastr.error('Mission has been deactivated successfully.');
                            }
                        },
                        error: function(xhr) {
