<x-admin-app-layout :title="'Officer All'">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    @foreach ($items as $key => $item)
                        @php
                            ...
                            $shouldBeRed3Months = collect($fieldsToCheck)->contains(function ($date) {
                                return $date &&
                            ...
                            $shouldBeRed6Months = collect($fieldsToCheck)->contains(function ($date) {
                                return $date &&
                                    \Carbon\Carbon::now()->greaterThanOrEqualTo(
    ...
    @foreach ($items as $key => $item)
        <div class="modal fade" id="showModal{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3 d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('admin.officer.edit', $item->id) }}" class="btn btn-light-primary">
