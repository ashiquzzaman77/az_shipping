<x-admin-app-layout :title="'Client Edit'">
    ...
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.client.update', $client->id) }}"
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="message" class="form-control @error('message') is-invalid @enderror">{{ old('message', $client->message) }}</textarea>
                                @error('message')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6 mb-3">
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <img class=""
                                            src="{{ !empty($client->image) ? url('storage/' . $client->image) : 'https://ui-avatars.com/api/?name=' . urlencode('C') }}"
