 <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
     ...
     <div class="aside-logo flex-column-auto" id="kt_aside_logo">
         ...
         <a class="text-center mx-auto" href="{{ route('admin.dashboard') }}">
             ...
             <h1 class="text-light">AZ Shipping</h1>
         </a>
     ...
     <div class="aside-menu flex-column-fluid">
         ...
         <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
             ...
             <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                 ...
                 {{-- SeaFear Section  --}}
                 @if (Auth::guard('admin')->user()->can('seafarer.menu'))
                 ...
                 <div data-kt-menu-trigger="click"
                     ...
                     <div
                         ...
                         {{-- Apply Job --}}
                         @if (Auth::guard('admin')->user()->can('job_apply.menu'))
                             <div class="menu-item">
                                 @if (Auth::guard('admin')->user()->can('all.job_apply'))
                 ...
                 {{-- Arrived Message --}}
                 @if (Auth::guard('admin')->user()->can('message.menu'))
                     <div class="menu-item">
                 ...
                 <div class="menu-item">
                     ...
                     <a class="menu-link {{ Route::is('admin.sent-message.index') ? 'active' : '' }}"
                         href="{{ route('admin.sent-message.index') }}">
                         <span class="menu-icon">
                 ...
                 @if (Auth::guard('admin')->user()->can('frontend.menu'))
                     <div data-kt-menu-trigger="click"
                         ...
                         <div
                             ...
                             {{-- Principle Section  --}}
                             @if (Auth::guard('admin')->user()->can('principle.menu'))
                                 <div class="menu-item">
                                     @if (Auth::guard('admin')->user()->can('all.principle'))
                             ...
                             {{-- Client Section  --}}
                             @if (Auth::guard('admin')->user()->can('client.menu'))
                                 <div class="menu-item">
                                     @if (Auth::guard('admin')->user()->can('all.client'))
                 ...
                 @if (Auth::guard('admin')->user()->can('admin.menu'))
                     <div data-kt-menu-trigger="click"
                         class="menu-item menu-accordion {{ Request::routeIs('all.admin.permission') ? 'here show' : '' }}">
                         ...
                         <div
                             class="menu-sub menu-sub-accordion menu-active-bg {{ Request::routeIs('all.admin.permission') ? 'here show' : '' }}">
