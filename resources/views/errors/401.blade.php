<x-admin-guest-layout :title="'401 Error'">
        ...
        <div class="row fullscreen-bg px-0">
            <div class="col-lg-12 content">
                ...
                <div>
                    ...
                    <h3 class="pt-5">You need to log in to access this page. <br> Please log in to continue.</h3>
                </div>
                <div class="mt-5 pt-5">
                    <a href="{{ route('login') }}" class="primary-btn-one">
                        Log In <i class="fa-solid fa-long-arrow-right"></i>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 content-bottom">
                <div class="error-footer">
                    <div>
                        <h1 class="card-title">Trouble Accessing?</h1>
