...
<body>
    <div class="container">
        <div class="header">
            <img src="http://azshipping.net/storage/images/settings/icA040G3xrUQ8qXzWusDxBIXuaNWPNTuf8PKcesl.png"
                style="width:170px;height:40px" alt="AZ Shipping Services">
